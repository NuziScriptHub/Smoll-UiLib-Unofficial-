...
function nuhuh.CreateDropdown(conpigs)
    conpigs = conpigs or {}
    conpigs.Text = conpigs.Text or "Dropdown"
    conpigs.TableList = conpigs.TableList or {"Option1", "Option2"}
    conpigs.Callback = conpigs.Callback or function(a) print(a) end

    local DropdownHolder = Instance.new("Frame")
    DropdownHolder.Size = UDim2.new(1, 0, 0, 30)
    DropdownHolder.BackgroundTransparency = 1
    DropdownHolder.Parent = Main_2

    local Button = Instance.new("TextButton")
    Button.Size = UDim2.new(1, 0, 1, 0)
    Button.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
    Button.TextColor3 = Color3.fromRGB(255, 255, 255)
    Button.Text = conpigs.Text .. ": [Select]"
    ...
    OptionsFrame.Size = UDim2.new(1, 0, 0, #conpigs.TableList * 25)
    ...
    for _, item in ipairs(conpigs.TableList) do
        ...
        Opt.MouseButton1Click:Connect(function()
            Button.Text = conpigs.Text .. ": [" .. item .. "]"
            OptionsFrame.Visible = false
            conpigs.Callback(item)
        end)
    end
